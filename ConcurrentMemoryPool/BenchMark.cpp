...
void BenchmarkMalloc(size_t ntimes, size_t nworks, size_t rounds)
{
	...
	cout << nworks << "个线程并发malloc&free " << nworks * rounds * ntimes << "次，总计花费：" << malloc_costtime + free_costtime <<
		"ms" << endl;
}
...
void BenchmarkConcurrentMalloc(size_t ntimes, size_t nworks, size_t rounds)
{
	...
	// 	nworks,nworks*rounds*ntimes, malloc_costtime + free_costtime);
	cout << nworks << "个线程并发concurrent alloc&dealloc " << nworks * rounds * ntimes << "次，总计花费：" << malloc_costtime +
		free_costtime <<
		"ms" << endl;
}
